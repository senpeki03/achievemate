  ...
  <ul class="nav-links">
       <li>
          ...
          <ul class="sub-menu blank">
              <li><a class="link_name" href="{{ route('registrar.dashboard') }}">Dashboard</a></li>
          </ul>
      </li>


        <li>
        <a href="{{ route('registrar.students.upload') }}">
            <i class='bx bx-user-plus'></i> <!-- Student Management -->
            <span class="link_name">Student Management</span>
        </a>
        <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('registrar.students.upload') }}">Student Management</a></li>
        </ul>
        </li>

        <li>
        <a href="{{ route('registrar.studentlist') }}">
            <i class='bx bx-group'></i> <!-- Student List -->
            <span class="link_name">Student List</span>
        </a>
        <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('registrar.studentlist') }}">Student List</a></li>
        </ul>
        </li>

        <li>
        <a href="#">
            <i class='bx bx-award'></i> <!-- Latin Honor List -->
  ...
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li><a class="dropdown-item" href="{{ route('registrar.userprofile') }}">Profile</a></li>
