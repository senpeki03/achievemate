{{-- resources/views/reports/posting.blade.php --}}
...
<head>
  ...
  <style>
    ...
    .logo-left-box,
    .logo-right-box {
      width: 82pt; height: 82pt; overflow: hidden;
      display: flex; align-items: center; justify-content: center;
    }

    /* Nudge amount (change once to move more/less) */
    /* Try 4–10pt depending on your taste */
    /* LEFT: move slightly LEFT; RIGHT: move slightly RIGHT */
    .logo-left-box  { margin: 0 auto 0 -6pt; }   /* <-- NUDGE LEFT */
    .logo-right-box { margin: 0 -6pt 0 auto; }   /* <-- NUDGE RIGHT */

    /* Visual balance (sizes) */
    .logo-left-box img  { height: 90%;  width: auto; display: block; object-fit: contain; }
    .logo-right-box img { height: 118%; width: auto; display: block; object-fit: contain; }
...
<body>
  ...
  {{-- ===== HEADER (logos with slight left/right shift) ===== --}}
