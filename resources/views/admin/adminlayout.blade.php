  ...
  <div class="logo-container d-flex align-items-center">
    ...
    <div class="logo-text">
      ...
      <ul class="nav-links">
        ...
        <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('admin.usermanagement') }}">User Management</a></li>
        </ul>
        </li>
        <li>
        ...
        <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('admin.user.list') }}">User List</a></li>
        </ul>
        </li>
        <li>
        <a href="#">
        ...
        <a href="{{ route('admin.systemlogs') }}">
            ...
            <span class="link_name">System Logs</span>
        </a>
        <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('admin.systemlogs')}}">System Logs</a></li>
        </ul>
        </li>
    </div>
