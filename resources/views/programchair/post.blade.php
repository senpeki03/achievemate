...
<div class="container py-4">
  ...
  <div class="card shadow-sm border-0 rounded-4">
    <div class="card-body px-4 py-4">
      ...
      <div class="bg-primary text-white rounded-3 p-3 mb-3">
        <h5 class="fw-bold text-uppercase mb-0">Announcement</h5>
      </div>
      ...
      <form id="announcementForm"
        ...
        <div class="mb-3">
          ...
          {{-- Minimal toolbar (only fullscreen + image button disabled to avoid HTML) --}}
          <div class="d-flex flex-wrap gap-2 p-2 border border-top-0 rounded-bottom-3 bg-light">
            ...
            {{-- Keep cover image uploader separate from body --}}
...
<script>
  function getEditorPlainText() {
    ...
    // innerText strips tags; keep user line breaks
...
<style>
  ...
  /* Keep whitespace so newlines are preserved visually while editing */
